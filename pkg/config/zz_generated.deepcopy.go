...
import (
	jenkinsfile "github.com/jenkins-x/jx/v2/pkg/jenkinsfile"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationDefaultsConfig) DeepCopyInto(out *ApplicationDefaultsConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationDefaultsConfig.
func (in *ApplicationDefaultsConfig) DeepCopy() *ApplicationDefaultsConfig {
	if in == nil {
		return nil
	}
	out := new(ApplicationDefaultsConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BuildPackConfig) DeepCopyInto(out *BuildPackConfig) {
	*out = *in
	out.BuildPackLibrary = in.BuildPackLibrary
	return
}
